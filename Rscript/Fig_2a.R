...
# 方法名称
methods <- c("Pre-trained PRS (PRSCS)", "Lasso", "AB-PRS", "AB-PRS (single val)", "BHq")
methods_fac <- c( "AB-PRS", "AB-PRS (single val)", "BHq", "Lasso","Pre-trained PRS (PRSCS)")
baseline<-"Pre-trained PRS (PRSCS)"
# 自定义颜色
custom_colors <- c(
  "Pre-trained PRS (PRSCS)" = "#F4A7B9",
  "Lasso" = "#d95f02",
  "AB-PRS" = "#A8D08D",
