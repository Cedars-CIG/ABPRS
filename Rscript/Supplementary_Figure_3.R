...
# 方法名称
methods <- c("Pre-trained PRS (MegaPRS)", "Lasso", "AB-PRS", "AB-PRS (single val)", "BHq")
methods_fac <- c( "AB-PRS", "AB-PRS (single val)", "BHq", "Lasso","Pre-trained PRS (MegaPRS)")
baseline<-"Pre-trained PRS (MegaPRS)"
# 自定义颜色
custom_colors <- c(
  "Pre-trained PRS (MegaPRS)" = "#F4A7B9",
  "Lasso" = "#d95f02",
  "AB-PRS" = "#A8D08D",
...
all_df <- read_excel("Supplementary_Figure_3.xlsx")
