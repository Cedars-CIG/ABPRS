...
# 方法名称
methods <- c("Pre-trained PRS (basic)", "Lasso", "AB-PRS", "AB-PRS (single val)", "BHq")
methods_fac <- c( "AB-PRS", "AB-PRS (single val)", "BHq", "Lasso","Pre-trained PRS (basic)")
baseline<-"Pre-trained PRS (basic)"
# 自定义颜色
custom_colors <- c(
...
all_df <- read_excel("Supplementary_Figure_1.xlsx")
