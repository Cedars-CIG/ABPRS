...
#' Generate simulation data with binary outcome
#' 
...
#' @return dataframe with phenotype in the first column and snps in the rest of the columns
#' @export
binary_simulation <- function(snps, effect_snps_vec, n, maf, effect_size, beta0){
  ...
  colnames(dat) <- c("Phenotype", paste0("SNP", c(1:snps)))
